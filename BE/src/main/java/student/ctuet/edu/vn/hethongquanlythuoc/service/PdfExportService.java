...
public class PdfExportService {
        ...
        public byte[] exportMedicineReport(LocalDate from, LocalDate to) throws Exception {
                ...
                congHoa.setAlignment(Element.ALIGN_CENTER);
                ...
                Paragraph dateLine = new Paragraph(
                                "Cần Thơ, Ngày " + to.getDayOfMonth() + " tháng " + to.getMonthValue() + " năm "
                                                + to.getYear(),
                                fontItalic);
                ...
                // ← XÓA đoạn doc.add(dateLine) riêng bên dưới
                ...
                Paragraph dateRange = new Paragraph(
                                from.getDayOfMonth() + "/" + from.getMonthValue() + "/" + from.getYear()
                                                + " - " + to.getDayOfMonth() + "/" + to.getMonthValue() + "/"
                                                + to.getYear(),
                                fontNormal);
                ...
                for (Medicine medicine : medicines) {
                        ...
                        table.addCell(
                                        makeDataCell(totalImport == 0 ? "-" : String.valueOf(totalImport), fontData,
                                                        Element.ALIGN_CENTER));
                        table.addCell(
                                        makeDataCell(totalExport == 0 ? "-" : String.valueOf(totalExport), fontData,
                                                        Element.ALIGN_CENTER));
                        table.addCell(
                                        makeDataCell(remaining == 0 ? "-" : String.valueOf(remaining), fontData,
                                                        Element.ALIGN_CENTER));
                        table.addCell(makeDataCell(valid == 0 ? "-" : String.valueOf(valid), fontData,
                                        Element.ALIGN_CENTER));
                        table.addCell(makeDataCell(expired == 0 ? "-" : String.valueOf(expired), fontData,
                                        Element.ALIGN_CENTER));
                }
